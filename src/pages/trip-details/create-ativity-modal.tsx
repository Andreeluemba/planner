...
export function CreateAtivityModal({closeCreateAtivityModal}:CreateAtivityModalProps){
  return(
          ...
          <div className="w-[648px] rounded-xl py-5 px-6 shadow-sm bg-zinc-900 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button onClick={closeCreateAtivityModal}><X className="size-5 text-zinc-400"/></button>
              </div>
            ...
            <form className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-transparent text-lg outline-none placeholder-zinc-400 flex-1 scheme-dark"
                />
              </div>  
              </div>
